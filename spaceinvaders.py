...
class Block(pygame.sprite.Sprite):
    ...
    def __init__(self, color = GOLD, size = 10):
...
class Ship(pygame.sprite.Sprite):
    ...
    def shoot(self):
        ...
        bullet = Bullet(self.rect.midtop, 2)
        return bullet
    ...
    def update(self, *args):
        ...
        # Se estiver pressionando o botão da seta da esquerda
            ...
            if self.rect.top < (SCREEN_HEIGHT - self.speed):
...
class Invader(pygame.sprite.Sprite):
    ...
    def shoot(self):
        ...
        """
        bullet = Bullet(self.rect.midtop, -1, speed = 4, color = SPRINGREEN)
        return bullet
...
class Mystery2(pygame.sprite.Sprite):
    """
    Classe que representa a Mystery do jogo tradicional.
    """

    def __init__(self, sprite, pos_x, pos_y, speed = 4):
        """
        Método responsável por criar a nave-mãe.
...
class Bullet(pygame.sprite.Sprite):
    ...
    def __init__(self, pos_xy, direction, color = RED, speed = 8):
        """
...
class SpaceInvaders():
    ...
    def __init__(self):
        ...
        self.path_image_ship = DIRECTORY + "/images/nave.png"
        ...
        mystery2_image = pygame.image.load(DIRECTORY + "/images/boss2.png")
        self.mystery2_image = pygame.transform.scale(mystery_image, [71, 39])
        self.mystery2 = pygame.sprite.GroupSingle(
                                Mystery2(self.mystery_image, self.random_position(), 20))
    ...
    def home_screen(self):
        ...
        text = self.font.render("UP SUPER BETA!!!", True, GREEN)
    ...
    def update(self):
        ...
        if ((len(self.mystery2) == 0)):
            self.mystery2.add(Mystery2(self.mystery2_image, self.random_position(), 20))
                ...
                if self.ship_sprite.lifes <= 0:
                    ...
                    for event in pygame.event.get():
                        ...
                        if event.type == pygame.KEYDOWN:
                            if event.key == pygame.K_ESCAPE:
                                run, menu = False, False
                            if ((event.key == pygame.K_SPACE) and not self.ship_shot):
